...
top_10$ecode1[1]
top_10$ecode1_desc[1]
cat_perc_by(temp, c("mortality", "top_10_ecode_E8261"))%>% my_print()
weights::wtd.chi.sq(temp$mortality, temp$top_10_ecode_E8261,
										weight = temp$discwt, mean1 = F) %>% knitr::kable()


top_10$ecode1[2]
top_10$ecode1_desc[2]
cat_perc_by(temp, c("mortality", "top_10_ecode_E8122")) %>% my_print()
weights::wtd.chi.sq(temp$mortality, temp$top_10_ecode_E8122,
										weight = temp$discwt, mean1 = F) %>% knitr::kable()

top_10$ecode1[3]
top_10$ecode1_desc[3]
cat_perc_by(temp, c("mortality", "top_10_ecode_E8162")) %>% my_print()
weights::wtd.chi.sq(temp$mortality, temp$top_10_ecode_E8162,
										weight = temp$discwt, mean1 = F) %>% knitr::kable()

top_10$ecode1[4]
top_10$ecode1_desc[4]
cat_perc_by(temp, c("mortality", "top_10_ecode_E8210")) %>% my_print()
weights::wtd.chi.sq(temp$mortality, temp$top_10_ecode_E8210,
										weight = temp$discwt, mean1 = F) %>% knitr::kable()

top_10$ecode1[5]
top_10$ecode1_desc[5]
cat_perc_by(temp, c("mortality", "top_10_ecode_E8136")) %>% my_print()
weights::wtd.chi.sq(temp$mortality, temp$top_10_ecode_E8136,
										weight = temp$discwt, mean1 = F) %>% knitr::kable()

top_10$ecode1[6]
top_10$ecode1_desc[6]
cat_perc_by(temp, c("mortality", "top_10_ecode_E8192")) %>% my_print()
weights::wtd.chi.sq(temp$mortality, temp$top_10_ecode_E8192,
										weight = temp$discwt, mean1 = F) %>% knitr::kable()

top_10$ecode1[7]
top_10$ecode1_desc[7]
cat_perc_by(temp, c("mortality", "top_10_ecode_E8182")) %>% my_print()
weights::wtd.chi.sq(temp$mortality, temp$top_10_ecode_E8182,
										weight = temp$discwt, mean1 = F) %>% knitr::kable()

top_10$ecode1[8]
top_10$ecode1_desc[8]
cat_perc_by(temp, c("mortality", "top_10_ecode_E8853")) %>% my_print()
weights::wtd.chi.sq(temp$mortality, temp$top_10_ecode_E8853,
										weight = temp$discwt, mean1 = F) %>% knitr::kable()

top_10$ecode1[9]
top_10$ecode1_desc[9]
cat_perc_by(temp, c("mortality", "top_10_ecode_E8152")) %>% my_print()
weights::wtd.chi.sq(temp$mortality, temp$top_10_ecode_E8152,
										weight = temp$discwt, mean1 = F) %>% knitr::kable()

top_10$ecode1[10]
top_10$ecode1_desc[10]
cat_perc_by(temp, c("mortality", "top_10_ecode_E8851")) %>% my_print()
weights::wtd.chi.sq(temp$mortality, temp$top_10_ecode_E8851,
										weight = temp$discwt, mean1 = F) %>% knitr::kable()
...
top_10$ecode1_desc[1]
cat_perc_by(temp, c("age_group", "top_10_ecode_E8261"))%>% my_print()
weights::wtd.chi.sq(temp$age_group, temp$top_10_ecode_E8261,
										weight = temp$discwt, mean1 = F) %>% knitr::kable()


top_10$ecode1_desc[2]
cat_perc_by(temp, c("age_group", "top_10_ecode_E8122")) %>% my_print()
weights::wtd.chi.sq(temp$age_group, temp$top_10_ecode_E8122,
										weight = temp$discwt, mean1 = F) %>% knitr::kable()


top_10$ecode1_desc[3]
cat_perc_by(temp, c("age_group", "top_10_ecode_E8162")) %>% my_print()
weights::wtd.chi.sq(temp$age_group, temp$top_10_ecode_E8162,
										weight = temp$discwt, mean1 = F) %>% knitr::kable()


top_10$ecode1_desc[4]
cat_perc_by(temp, c("age_group", "top_10_ecode_E8210")) %>% my_print()
weights::wtd.chi.sq(temp$age_group, temp$top_10_ecode_E8210,
										weight = temp$discwt, mean1 = F) %>% knitr::kable()


top_10$ecode1_desc[5]
cat_perc_by(temp, c("age_group", "top_10_ecode_E8136")) %>% my_print()
weights::wtd.chi.sq(temp$age_group, temp$top_10_ecode_E8136,
										weight = temp$discwt, mean1 = F) %>% knitr::kable()


top_10$ecode1_desc[6]
cat_perc_by(temp, c("age_group", "top_10_ecode_E8192")) %>% my_print()
weights::wtd.chi.sq(temp$age_group, temp$top_10_ecode_E8192,
										weight = temp$discwt, mean1 = F) %>% knitr::kable()


top_10$ecode1_desc[7]
cat_perc_by(temp, c("age_group", "top_10_ecode_E8182")) %>% my_print()
weights::wtd.chi.sq(temp$age_group, temp$top_10_ecode_E8182,
										weight = temp$discwt, mean1 = F) %>% knitr::kable()


top_10$ecode1_desc[8]
cat_perc_by(temp, c("age_group", "top_10_ecode_E8853")) %>% my_print()
weights::wtd.chi.sq(temp$age_group, temp$top_10_ecode_E8853,
										weight = temp$discwt, mean1 = F) %>% knitr::kable()


top_10$ecode1_desc[9]
cat_perc_by(temp, c("age_group", "top_10_ecode_E8152")) %>% my_print()
weights::wtd.chi.sq(temp$age_group, temp$top_10_ecode_E8152,
										weight = temp$discwt, mean1 = F) %>% knitr::kable()


top_10$ecode1_desc[10]
cat_perc_by(temp, c("age_group", "top_10_ecode_E8851")) %>% my_print()
weights::wtd.chi.sq(temp$age_group, temp$top_10_ecode_E8851,
										weight = temp$discwt, mean1 = F) %>% knitr::kable()

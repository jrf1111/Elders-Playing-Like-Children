...
saveRDS(mort_mod, "Results/mort_mod_some_groups_randef.DRS")
...
saveRDS(mort_mod2, "Results/mort_mod_some_groups_fixed.DRS")
...
#throws error: 
# Error in get_quant_loclin(pfct, p, interval = interval, link = link, ptol = ptol,  : 
